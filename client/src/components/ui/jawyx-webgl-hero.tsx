...
export function JawyxWebGLHero() {
  ...
  const goTo = (id: "work" | "contact") => { const target = document.getElementById(id); if (!target) return; window.history.pushState({}, "", `#${id}`); target.scrollIntoView({ behavior: "smooth", block: "start" }); };
